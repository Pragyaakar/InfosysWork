 ...
 */
 define(['N/ui/serverWidget','N/runtime','N/email','N/http','N/redirect','N/search'], function (serverWidget,runtime,email,http,redirect,search) {
    try{
     function onRequest(context) {
         if (context.request.method === 'GET') {
          ...
          form.addField({
           ...
           var path = form.clientScriptModulePath = 'SuiteScripts/CS_AH_Trans.js';
