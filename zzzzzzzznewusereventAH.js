     ...
     function beforeLoad(scriptContext) {
         try {
             ...
             if (scriptContext.type == 'view') {
                 ...
                 var first_approver = obj_record.getValue('custbody_ah_first_approver');
                 var second_approver = obj_record.getValue('custbody_ah_second_approver');
                 var third_approver = obj_record.getValue('custbody_ah_third_approver');
                 var fourth_approver = obj_record.getValue('custbody_ah_fourth_approver');
                 var fifth_approver = obj_record.getValue('custbody_ah_fifth_approver');
                 var sixth_approver = obj_record.getValue('custbody_ah_sixth_approver');
                 var seventh_approver = obj_record.getValue('custbody_ah_seventh_approver');
                 log.debug({
                     title: 'approver',
                     details: 'approver :' + 'first_approver:' + first_approver + 'second_approver:' + second_approver + 'third_approver:' + third_approver + 'fourth_approver: ' + fourth_approver + 'fifth_approver: ' + fifth_approver + 'sixth_approver: ' + sixth_approver + 'seventh_approver: ' + seventh_approver
                 });
                 ...
                 if ((isNotEmpty(next_approver) && (next_approver == current_user_id) && (approval_status == 6))) {
                     ...
                     var onRejectButtonClick = "win = window.open";
                     scriptContext.form.addButton({
                         id: "custpage_reject",
                         label: "Reject",
