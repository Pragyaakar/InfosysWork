              ...
              // alert('status inside edit submit to approval'+status);
               ...
               {    
                ...
                // }
                  ...
                  poRec.setValue({fieldId: 'custbody_ah_next_approver',value: nwar[i]});
                 // log.debug(' mewapp', mewapp);
                  log.debug(' nwar[i]', nwar[i]);

               }
           // var nw = new Array();
            //    var nextapp = poRec.getValue({fieldId : 'custbody_ah_next_approver' });
            //    log.debug('nextapp',nextapp);
            //    var approvedBy = poRec.getValue({fieldId : 'custbody_ah_approved_by' });
            //    log.debug('approvedBy',approvedBy);
            //    if(approvedBy.indexOf(firstapp) == -1 &&  nextapp == '')
            //    {
            //     log.debug('approvedByfirst ppp',approvedBy);
            //     poRec.setValue({fieldId: 'custbody_ah_next_approver',value:firstapp});
            //    }else if(approvedBy.indexOf(secondapp) == -1 &&  nextapp == firstapp) {
            //     log.debug('approvedByecoondirst ppp',approvedBy);
